    ...
    <div class="container-fluid custom-container booking-form-center">
        <form action="" class="booking-form">
            <div class="booking-form-text-section">
                <h2 class="booking-form-header text-uppercase text-center">pending</h2>
            </div>
            <div class="name-input-box">
                <h6 class="text-uppercase fw-bold">name</h6>
                <div class="name-input-boxes">
                    
                    <input type="text" name="" id="" class="margin-bottom-name-input-field">
                    <input type="text" name="" id="">
                </div>
            </div>
            <div class="room-guests-dropdowns">
                <div class="room-dropdown">
                    <h6 class="text-uppercase fw-bold">room</h6>
                    <div class="dropdown">
            ...
            <div class="stay-dates-input-box">
                <h6 class="text-uppercase fw-bold">stay dates</h6>
            ...
            <div class="booking-form-btn-section">
                <button type="button" class="btn booking-form-btn fw-bold text-uppercase">cancel booking</button>
            </div>
        </form>
    </div>
